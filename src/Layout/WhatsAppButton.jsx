...
function WhatsAppButton() {
  ...
  const whatsappNumber = '442034759906'; // Same as footer
  const whatsappUrl = `https://wa.me/${whatsappNumber}`;
  const defaultColor = '#D7B75E'; // Gold/yellow theme color
  const hoverColor = '#25D366'; // WhatsApp green on hover
  const defaultBg = 'rgba(215, 183, 94, 0.15)';
  const hoverBg = 'rgba(37, 211, 102, 0.15)';
  ...
  return (
    <a
      ...
      style={{
        ...
        border: `1px solid ${hovered ? hoverColor + '30' : defaultColor + '40'}`,
